...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AaravWebSolution.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AaravWebSolution.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
...
Marketing CRMis ",
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Services", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
...
And at Aarav Web Solution, we endeavor to make every like a virtual action. We generate leads, raise brand awareness, expand your brand's audience, and much more.",
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Cart", b =>
                {
                    b.HasOne("AaravWebSolution.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("AaravWebSolution.Models.Package", "Package")
                        .WithMany()
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AaravWebSolution.Models.Services", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("AaravWebSolution.Models.OrderDetails", b =>
                {
                    b.HasOne("AaravWebSolution.Models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("AaravWebSolution.Models.Package", b =>
                {
                    b.HasOne("AaravWebSolution.Models.Services", "Services")
                        .WithMany()
